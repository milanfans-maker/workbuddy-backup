---
name: seedance
description: "基于 Seedance 视频生成 的 AI 视频生成器，覆盖 Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance 的裸接口与全部公开模式。当用户需要 Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance、文生视频、图生视频、参考生视频、AI视频、视频生成、广告、TVC、带货、种草、短剧、漫剧 时使用此 Skill。"
description_zh: "基于 Seedance 视频生成 的 AI 视频生成器，覆盖 Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance 的裸接口与全部公开模式。当用户需要 Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance、文生视频、图生视频、参考生视频、AI视频、视频生成、广告、TVC、带货、种草、短剧、漫剧 时使用此 Skill。"
version: 1.0.0
------
...
- 独立占据 `seedance` 搜索入口，不与其他模型或能力 Skill 合并
...
| `init --skill-name seedance` | 初始化 API Key |
...
python3 "$SKILL_PATH/scripts/videogen.py" generate \
  --mode t2v \
  --prompt "电影感城市夜景，镜头缓慢推进，灯光倒映在湿润路面"
```
...
```bash
python3 "$SKILL_PATH/scripts/videogen.py" init --skill-name seedance
```
